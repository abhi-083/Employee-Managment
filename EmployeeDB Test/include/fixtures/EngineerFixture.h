...
protected:
	void SetUp() override {
		...
		engineer->setFirstName("Abhi");
		engineer->setMiddleName("");
		engineer->setLastName("Patel");
		engineer->setDateOfBirth("11-09-2002");
		engineer->setMobileNo(8756908765);
		engineer->setEmail("abb.ptt@gmail.com");
		...
		engineer->setTechnology("React");

		emptyEngineer = std::make_unique<Engineer>(true);

		DBManager::executeConfigQuery();

		std::string_view insertQuery = R"(INSERT INTO Department("departmentID", "departmentName", "baseSalary", "allowance", "deduction") VALUES (1, 'Engineer', 65000, 7000, 3000);)";
		...
		insertQuery = "INSERT INTO Engineer(\"employeeID\", \"technology\") VALUES (1, 'C++'),(2, 'NodeJS');";
